/*
 * Digitize 3 channels with 10 bit resolution from
 ...
 * 
 * Three channels are digitized at a specified sampling rate. The 16 bit timer is 
...
#define NUM_CHANNELS 3 // digitizing three channels
